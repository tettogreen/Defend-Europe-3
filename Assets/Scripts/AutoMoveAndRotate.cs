...
public class AutoMoveAndRotate : MonoBehaviour
{
	...
	GameObject player;
	Vector3andSpace defaultMoveUnitsPerSecond;
	...
	private void Start ()
	{
		...
		defaultMoveUnitsPerSecond = new Vector3andSpace(moveUnitsPerSecond);
		Initialize();
	}
	...
	private void SetMovementAccordingToPosition ()
	{
		...
		moveUnitsPerSecond.value = defaultMoveUnitsPerSecond.value;
		return;
	}
	...
	public class Vector3andSpace
	{
		...
		public Vector3andSpace(Vector3andSpace clone)
		{
			value = clone.value;
			space = clone.space;
		}
